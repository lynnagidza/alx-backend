...
This project is about building a queuing system in JavaScript using Redis.
...
## Requirements
[![ubuntu](https://img.shields.io/badge/ubuntu-18.04-orange.svg?style=flat)](http://releases.ubuntu.com/18.04/)
[![nodejs](https://img.shields.io/badge/nodejs-12.x-green.svg?style=flat)](https://nodejs.org/en/)
[![redis-server](https://img.shields.io/badge/Redis-5.0.7-red.svg?style=flat)](https://redis.io/)
...
In a file named `1-redis_op.js`, copy the code you previously wrote (`0-redis_client.js`).
...
In a file named `2-redis_op_async.js`, copy the code you previously wrote (`1-redis_op.js`).
...
Create an express server listening on the port 1245. (You will start it via: n`pm run dev 100-seat.js`)
